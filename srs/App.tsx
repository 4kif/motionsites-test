...
const NavItem = ({ number, label, delay }: NavItemProps) => (
  <div
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full h-full">
        ...
        <nav className="absolute top-0 left-0 w-full flex items-center px-5 md:px-[35px] py-5 md:py-[27px]">
          ...
          <div className="flex items-center gap-[40px]">
            ...
            <div className="hidden lg:flex items-center gap-[40px]">
              <NavItem number="01" label="ECOSYSTEM" delay={350} />
              <NavItem
                number="02"
                label="LIQUIDITY_POOLS"
                delay={450}
              />
              <NavItem number="03" label="LUMEN_INDEX" delay={550} />
              <NavItem number="04" label="GOVERNANCE" delay={650} />
            </div>
          </div>
        ...
        <div className="absolute bottom-5 md:bottom-[35px] left-5 md:left-[35px] right-5 md:right-[35px] flex flex-col md:flex-row items-start md:items-end justify-between gap-5 md:gap-0">
          ...
          >
            <span className="text-black text-[16px] leading-none">
              &#10022;
            </span>
          ...
          <div
            ...
            style={{ animationDelay: '1100ms' }}
          >
            <div className="font-manrope text-black text-[13px] leading-[15.6px] bg-[#AFDDFF] px-[6px] py-[2px] inline-block mb-[10px]">
            ...
            <div className="relative p-[20px]">
              ...
              <p className="relative font-manrope text-white text-[13px] leading-[18px] mb-[18px]">
                Maps the complexity of modern finance with a partner that
                brings clarity and organic growth to your portfolio.
              </p>
